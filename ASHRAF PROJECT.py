...
class mainT(QThread):
    ...
    def STT(self):
        try:
            ...
            with sr.Microphone() as source:
                ...
                R.energy_threshold = 300  # Adjust sensitivity; lower for quieter environments
                print("Listening...........")
    ...
    def JARVIS(self):
        ...
        while True:
            ...
            if 'introduce yourself' in self.query or 'who are you' in self.query:
          ...
          "How can I assist you today?")
            elif 'what is your name' in self.query or 'your name' in self.query:
             ...
             speak("I was created by Ashraf Ali. He is a computer science student and a technology enthusiast. "
            "He designed me to assist users like you with various tasks and provide information. "
            "If you have any questions or need assistance, feel free to ask!")
            elif 'what is your purpose' in self.query or 'what can you do' in self.query:
             speak("My purpose is to assist you with various tasks, such as answering questions, "
          "providing information, controlling applications, and helping you with daily activities. "
            "I can also tell jokes, play music, and perform calculations. "
            "If you have any specific requests or questions, just let me know!")
          ...
          "including robotics, healthcare, finance, and more. Would you like to know anything else?")
            ...
            if "jarvis i am tired" in self.query:
             ...
             speak(datetime.datetime.now().strftime("Today's date is %A, %d %B %Y, and the time is %I:%M %p."))
                ...
                os.startfile(r"C:\Windows\System32\Camera.exe")
                ...
                os.startfile(r"C:\Users\ashra\AppData\Local\WhatsApp\WhatsApp.exe")
...
class Main(QMainWindow,FROM_MAIN):
    def __init__(self,parent=None):
        ...
        Dspeak = mainT()
        self.label_7 = QMovie(os.path.join(os.path.dirname(__file__), "lib", "gifloader.gif"), QByteArray(), self)
        ...
        Dspeak.start()
        self.label.setPixmap(QPixmap(os.path.join(os.path.dirname(__file__), "lib", "tuse.png")))
